...
const showCards = () => {
  ...
  projects.forEach(({ title, cardImage, Previewlink, Githublink, Videolink }) => {
    ...
    if (Videolink) {
      output += `<li><a href="${Videolink}" class="social-icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 28" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-video"><path d="M23 7l-7 5 7 5V7z"></path><rect x="1" y="5" width="20" height="14" rx="2" ry="2"></rect></svg></a></li>`;
    }
